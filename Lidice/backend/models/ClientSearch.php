...
class ClientSearch extends Client
{
    ...
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['cliente', 'marka', 'ruc', 'contacto', 'telofic', 'celular', 'direccionexacta'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'cliente', $this->cliente])
            ...
            ->andFilterWhere(['like', 'telofic', $this->telofic])
            ->andFilterWhere(['like', 'celular', $this->celular])
            ->andFilterWhere(['like', 'direccionexacta', $this->direccionexacta]);
