...
<div class="site-index">
    ...
    <div class="jumbotron">
		<?php if (User::UserCan(["Preparado","Despachado"])) { ?>
			<p><a class="btn btn-lg btn-success" href="<?=Url::to(['mainlist/index'])?>">Main Lists</a></p>
		<?php } ?>
		<?php if (User::UserCan("Movir")) { ?>
			...
			<p><a class="btn btn-lg btn-success" href="<?=Url::to(['tipocodigo/index'])?>">Tipo Codigo</a></p>
		<?php } ?>
